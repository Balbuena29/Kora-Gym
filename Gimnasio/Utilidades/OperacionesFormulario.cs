...
namespace Gimnasio.Utilidades
{
    ...
    class OperacionesFormulario
    {
        ...
        ///Imagen
        public static byte[] conviertePicBoxImageToByte(System.Windows.Forms.PictureBox pbImage)//Convierte imagen a bytes para guardarlo en base de datos
        {
            System.IO.MemoryStream ms = new System.IO.MemoryStream();
            System.Drawing.Bitmap bmap = new System.Drawing.Bitmap(pbImage.Image);//Liena agregada para evitar la de exepcion de gdi
